...
export const H2 = ({ children, id }: PropsWithChildren<HProps>) => (
  <h2 className="text-yellow-fp mt-8 mb-4 text-lg font-bold uppercase" id={id}>
    {children}
  </h2>
);

export const H3 = ({ children }: PropsWithChildren<HProps>) => (
  <h3 className="mt-6 mb-2 font-bold">{children}</h3>
);

export const H4 = ({ children }: PropsWithChildren<HProps>) => (
  <h4 className="mt-6 mb-2 text-sm font-bold">{children}</h4>
);
