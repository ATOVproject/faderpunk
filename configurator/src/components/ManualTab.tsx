...
const apps: ManualAppData[] = [
  ...
  },
  {
    appId: 14,
    title: "Quantizer",
    description: "Quantize and transpose CV in a ±5V range",
    color: "Blue",
    icon: "quantize",
    params: ["Color"],
    storage: ["Octave shift", "Semitone shift", "Offset toggles"],
    text: "A CV quantizer and transposer operating in the ±5V range. Jack 1 is the input, Jack 2 is the output.\n\n**Fader 1** shifts the pitch up by 0–12 semitones. **Fader 2** shifts by ±5 octaves. Both offsets are applied to the input signal before it reaches the global quantizer. **Button 1** and **Button 2** toggle their respective shifts — button lit means the shift is active, button dim means it is bypassed. Shift states are saved per scene.\n\nWhen the global quantizer is set to **Off**, pitch quantization is bypassed entirely and the app acts as a pure transpose — the CV passes through with only the semitone and octave offsets applied.",
    channels: [
      {
        jackTitle: "Input",
        jackDescription: "CV signal input, ±5V range",
        faderTitle: "Semitone Shift",
        faderDescription: "Shifts the input pitch up by 0–12 semitones before quantization",
        fnTitle: "Toggle Semitone Shift",
        fnDescription: "Button lit: shift active. Button dim: shift bypassed.",
        ledTop: "Semitone shift level — brightness tracks the fader position",
        ledBottom: "",
      },
      {
        jackTitle: "Output",
        jackDescription: "Quantized CV output, ±5V range",
        faderTitle: "Octave Shift",
        faderDescription: "Shifts the input pitch by ±5 octaves before quantization",
        fnTitle: "Toggle Octave Shift",
        fnDescription: "Button lit: shift active. Button dim: shift bypassed.",
        ledTop: "Output level — lit when output is above 0V",
        ledBottom: "Output level — lit when output is below 0V",
      },
    ],
  },
