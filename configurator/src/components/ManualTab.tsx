...
const apps: ManualAppData[] = [
...

  {
    ...
    color: "Yellow",
    icon: "sine",
    params: ["Speed division", "Range", "MIDI Channel", "MIDI CC", "NRPN", "Send MIDI"],
  ...
  },
  {
    ...
    color: "Orange",
    icon: "euclid",
    params: ["MIDI mode", "Midi channel", "CC number", "Color", "Range", "Base note", "NRPN"],
  ...
  },
  {
    ...
    color: "Yellow",
    icon: "sine",
    params: ["Speed division", "Range", "MIDI Channel", "MIDI CC", "Color", "NRPN", "Send MIDI"],
    storage: [
      "CV attenuation",
      "CV mute",
      "CV destination",
