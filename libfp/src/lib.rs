...
pub enum Key {
    ...
    Gamelan,
    HungarianMin,
    // Added from https://github.com/thorinside/soma/blob/ab584d8afcaa5a7ff6df44a6ecfd560a0acc26ed/soma.lua#L8 below:
    MajorFlat6,
    LydianSharp4,
    Persian,
    Byzantine,
...
impl Key {
    ...
    pub fn as_u16_key(&self) -> u16 {
        match self {
            ...
            Key::MajorFlat6 =>      0b101011011001,
            Key::LydianSharp4 =>    0b101010110110,
            Key::Persian =>         0b110011101001,
            Key::Byzantine =>       0b110011011001,
            Key::Enigmatic =>       0b110010101011,
            Key::NeapolitanMinor => 0b110101011001,
            Key::Hirajoshi =>       0b101100011000,
            Key::Iwato =>           0b110001100010,
            Key::Pelog =>           0b110100010010,
            Key::RitsuJapan =>      0b101001010100,
            Key::YoJapan =>         0b101001010010,
        }
    }
}
