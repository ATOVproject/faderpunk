...
pub static CLOCK_IN_CHANNEL: Channel<CoreLocalRawMutex, ClockInEvent, 16> = Channel::new();
pub static TRANSPORT_CMD_CHANNEL: Channel<CoreLocalRawMutex, TransportCmd, 8> = Channel::new();
...
pub static SYNC_ENGINE_CHANNEL: Channel<CoreLocalRawMutex, SyncEngineEvent, 16> = Channel::new();
...
#[embassy_executor::task]
pub async fn run_clock_gatekeeper() {
...
pub async fn run_unified_clock_engine() {
    let mut config_receiver = GLOBAL_CONFIG_WATCH.receiver().unwrap();
