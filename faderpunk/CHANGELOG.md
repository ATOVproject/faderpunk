...
- use Curve::Deadzone on the swing fader
- [tb3po] snap length fader to 16 steps via Curve::Deadzone
- [seq8] snap length fader to 8 steps via off-center Curve::Deadzone
- [turing/turing+] use Curve::Deadzone for balanced 50/50 probability
