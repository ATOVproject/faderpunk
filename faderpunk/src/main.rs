...
use embassy_rp::clocks::{ClockConfig, CoreVoltage, RoscRng};
...
use fp_core::storage::{
    factory_reset, load_calibration_data, load_global_config, load_layout, migrate_fram,
    store_layout,
};
use fp_core::tasks::buttons::{is_channel_button_pressed, is_scene_button_pressed};
use fp_core::tasks::fram::MAX_DATA_LEN;
...
async fn main(spawner: Spawner) {
    ...
    // Hook up the RP2350 hardware RNG and reset to fp-core
