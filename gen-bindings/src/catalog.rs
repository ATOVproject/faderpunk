...
//! straight from `fp-core/src/apps/*.rs` and emits
...
/// `generate` reads `fp-core/src/apps/mod.rs` + each registered app's
/// source file under `fp_core_src`, and writes the generated catalog to
/// `out_file`.
pub fn generate(fp_core_src: &Path, out_file: &Path) {
    let apps_dir = fp_core_src.join("apps");
    ...
    out.push_str(
        "// AUTO-GENERATED by gen-bindings from fp-core/src/apps/*.rs — do not edit by hand.\n",
    );
